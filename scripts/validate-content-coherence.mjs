...
for (const required of [
  ...
  "initialPromptRef",
	  ...
	  "Start with a question about the public work",
	  "cite sources",
	  "separate evidence from inference",
	  "name uncertainty",
	  "record is thin",
	  "Reading the public evidence...",
	  "Ask about the work, Operational Intelligence, projects, or background...",
	  "Explore the public work, frameworks, and operating principles behind seri.ai.",
