...
for (const required of [
  ...
  "The claim is narrow",
  "Proof surface",
  "A serious operating model should invite inspection.",
  "Falsification tests",
  ...
  "The public posts converge on one problem: enterprises do not own their operational context yet.",
  "homeLinkedInSignals",
...
for (const required of [
  ...
  "initialPromptRef",
	  ...
	  "Question the doctrine, the Operations Room, and the builder proof.",
  "Answer packet",
  "question_category",
  "framework_layers",
  "related_pages",
