...
for (const required of [
  ...
  "Three ways to challenge the thesis.",
  "The model is not the moat. The operating harness is.",
  "The canonical assets, in reading order.",
...
for (const required of [
  ...
  "Operating arc",
  "From operating enterprise systems to reasoning about them.",
  ...
  "Review question",
  "What a project-code review should record.",
  "inspected surface, visible behavior, verdict",
  "boundary respected, and next proof",
...
for (const required of [
  ...
  "Run the case",
  "Challenge the claim",
  "What would prove, weaken, or falsify the thesis?",
  ...
  "The profile is not hidden behind the doctrine.",
  "professionalGraph.profileDiscovery.map",
...
for (const required of [
  ...
  "15+ years",
  "Distributed enterprise systems, integration, identity, observability, platform reliability, and production support.",
  ...
  "Production AI systems and agentic operations",
  "Context, evidence, and accountable action.",
  "Career story",
  "From enterprise infrastructure to AI operations judgment.",
  "Enterprise Integration",
  "Middleware & API Architecture",
  "Identity & Platform Engineering",
  "Cloud & Kubernetes",
