...
for (const required of [
  ...
  "Ravikanth Seri's public writing and working notes",
  ...
  "Three ways to understand Ravikanth Seri.",
...
for (const required of [
  ...
  "homeLinkedInSignals",
  "Ravikanth Seri's operating record.",
  "Operating arc",
  "Ravikanth Seri's operating arc.",
...
for (const required of [
  ...
  "Ravikanth Seri's background and operating arc.",
