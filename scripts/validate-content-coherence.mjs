...
for (const required of [
  ...
  "Operations Room signal",
  "Operational context is the new control plane.",
  "AI-native operations should move from telemetry and alerts to evidence-backed decisions",
  "Everything here is public-safe and inspectable",
