...
for (const required of [
  ...
  "The hard problem in enterprise AI is not answering faster.",
  "Inspection ledger",
...
for (const required of [
  ...
  "initialPromptRef",
	  ...
	  "cite sources",
	  "name uncertainty",
	  "refuse confidential or unsupported claims",
...
for (const required of [
	  ...
	  "Ask the work. Inspect the receipts.",
	  "Ask Ravi is an AI assistant over approved public content",
