...
for (const required of [
  ...
  "The point is not to make operations sound intelligent.",
  "The minimum bar",
  "Can it preserve contradiction?",
  "Can it say what is missing?",
  "Can another team replay it?",
  "Can a human stop action?",
  "Category boundary",
  ...
  "Inspection ledger",
  "The work earns trust only if it can be inspected.",
  "Doctrine v1.0",
...
for (const required of [
	  "Ask Ravikanth | Operational Intelligence Evidence Interface",
	  "const askRaviPrompts",
	  "Interrogate the evidence behind Operational Intelligence.",
	  "Do not read the thesis passively. Put pressure on it.",
	  "public evidence only; uncertainty stays visible",
	  "Evidence inquiry surface",
	  "Expose sources",
	  "Separate inference",
	  "Stop at evidence",
