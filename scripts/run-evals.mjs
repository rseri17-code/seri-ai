...
function deterministicFallbackAnswer(question) {
  ...
  const visitorReviewContext =
    /visitor review|first[- ]time review|first[- ]time visitor review|review kit|feedback kit|what was clear|what was confusing|most memorable idea|strongest claim|weakest claim|evidence would change|implementation question|submit.*review|evaluate.*site|evaluate.*ravikanth/.test(lower)
      ? " First-Time Visitor Review Kit: /start-here now gives reviewers a path to orient, inspect the person-work link, inspect proof, challenge the thesis, run the Operations Room, and submit public-safe feedback through /contact. The Practitioner Review Packet at /publication-pack/ravikanth-seri-practitioner-review-packet.md defines reviewer roles, review sequence, review dimensions, safe metadata, verdicts, do-not-capture rules, and a minimum external evidence quorum. Useful feedback should name what was clear, what was confusing, the most memorable idea, strongest and weakest claims, evidence needed, and implementation questions without confidential material. No external practitioner verdicts have been published yet."
      : "";
  ...
  return [
    ...
    "Public source: approved public content registry, including the Doctrine, Reference Architecture, Publication Pack, Evidence Pack, framework, and public wiki sources.",
