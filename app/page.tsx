        ...
        <div className="mx-auto grid max-w-7xl gap-5 px-4 py-6 sm:px-6 sm:py-8 lg:min-h-[90vh] lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-200">
              ...
              and bounded action. This site is the public operating model for AI-native operations: the public record of the
              career, the work, and the evidence behind that work, with the arc visible from enterprise integration and
              infrastructure to production AI systems and agentic operations.
            </p>
