...
export const metadata: Metadata = {
  title: "Start Here | Ravi Seri — Operational Intelligence",
  description: "Audience-specific paths through Ravi Seri's public Operational Intelligence, agentic systems, enterprise AI architecture, and evaluation work."
};
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {startHerePaths.map((path) => (
          <Card key={path.audience}>
            ...
            <p className="mt-5 text-sm font-semibold uppercase tracking-[0.16em] text-signal">Ask Ravi</p>
