    ...
    <Section eyebrow="Route not found" title="The requested artifact is not in the public surface.">
      <Card className="max-w-3xl border-signal/25 bg-signal/[0.055]">
        ...
        <p className="text-lg leading-8 text-slate-200">
          Ravikanth Seri&apos;s public site only exposes approved public artifacts. Use the map, library, or Ask Ravikanth to continue through the Operational Intelligence system.
        </p>
