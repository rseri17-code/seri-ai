    ...
    >
      {open ? (
        <div
          ...
          className="pointer-events-auto flex h-[min(36rem,70dvh)] w-[min(24rem,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-lg border border-white/10 bg-[#071018] shadow-[0_18px_60px_rgba(0,0,0,0.45)] motion-safe:transition-opacity sm:w-[24rem]"
        >
