...
export function BatchIntelligenceProof() {
  return (
    <section id="batch-intelligence" aria-labelledby="batch-intelligence-title" className="mt-4 overflow-hidden rounded-xl border border-signal/25 bg-signal/[0.035]">
