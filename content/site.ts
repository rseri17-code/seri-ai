...
export const approvedKnowledge = [
  ...
  String(practitionerReviewPacket.minimumEvidenceQuorum.minimumReviewerCount),
  ...practitionerReviewPacket.minimumEvidenceQuorum.requiredCoverage,
  practitionerReviewPacket.minimumEvidenceQuorum.completionRule,
  practitionerReviewPacket.minimumEvidenceQuorum.revisionTrigger,
  ...practitionerReviewPacket.reviewRunProtocol.flatMap((item) => [item.phase, item.instruction]),
  ...
  ...resume.education.flatMap((item) => [item.credential, item.issuer, item.status, item.sourceClass, item.supports]),
  ...resume.certifications.flatMap((item) => [item.credential, item.issuer, item.issued ?? "", item.status, item.sourceClass, item.supports, item.doesNotProve]),
